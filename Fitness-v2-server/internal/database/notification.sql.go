...
func (q *Queries) MarkNotificationAsReadByNotificationID(ctx context.Context, id uuid.UUID) error {
	_, err := q.db.ExecContext(ctx, markNotificationAsReadByNotificationID, id)
	return err
}
